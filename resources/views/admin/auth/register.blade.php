...
<div class="w3layouts-main">
	...
	@endphp
		<form action="{{url('/register')}}" method="post">
            ...
            <input type="number" class="ggg" name="admin_phone" placeholder="Phone" value="{{old('admin_phone')}}">
            <input type="email" class="ggg" name="admin_email" placeholder="Email" value="{{old('admin_email')}}">
