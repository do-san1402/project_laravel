    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
                ...
                <li><a href="#"><i class="fa fa-cog"></i> Cài đằng </a></li>
                <li><a href="{{url('/logout-admin')}}"><i class="fa fa-key"></i> Đăng xuất</a></li>
            </ul>
        </li>
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{url('/add-category-product')}}">Thêm mới danh mục</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{url('/add-brand-product')}}">Thêm mới thương hiệu</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{url('/manager-order')}}">Quản lý đơn hàng</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{url('/manager-banner')}}">Quản lý banner</a></li>
						<li><a href="{{url('/create-banner')}}">Thêm banner</a></li>
                    ...
                    if(session() -> get('roles') == 'admin') {
                        ?>
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    <li><a href="{{url('/all-users')}}">Liệt kê Users </a></li>
                                    <li><a href="{{url('/store-users')}}">Thêm User </a></li>
