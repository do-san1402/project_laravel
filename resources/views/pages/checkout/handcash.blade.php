...
<div class="nk-fullscreen-block">
    <div class="nk-fullscreen-block-top">
        <div class="text-center">
            ...
            <a href="index.html"><img src="{{asset('images/logo-2.png')}}" alt="GoodGames"></a>
        ...
        <div class="container text-center">
            <div class="row">
                <div class="col-md-6 offset-md-3 col-lg-4 offset-lg-4">
                    <h1 class="h2"><span class="text-main-1">Kết nối </span>mọi người</h1>

                    <div class="text-white">Cảm ơn bạn đã đặt hàng ở chổ chúng tối, chúng tôi sẽ liên lạc với bạn sớm nhất có thể.</div>
                    <div class="nk-gap-2"></div>
