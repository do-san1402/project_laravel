...
<div class="nk-main">
    ...
    <div class="container">
        ...
        <div class="row vertical-gap">
            <div class="col-lg-8">
                <h3 class="nk-decorated-h-2"><span><span class="text-main-1">Kết quả</span> tìm kiếm </span></h3>
                <div class="row vertical-gap ">

                    <?php
                        foreach($products_search as $k_product => $v_product) {
                            ?>
                                <div class="col-md-6">
                                    <div class="nk-product-cat">
                                        ...
                                        <div class="nk-product-cont">
                                            ...
                                            <div class="nk-gap-1"></div>
                                            <a href="#" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 nk-btn-hover-color-main-1">Mua ngay</a>
                                        </div>
                                    </div>
                                </div>
